...
extension SubB2VC {
  private func setupYearlyView(with boderWidth: CGFloat = 2, boderColor: UIColor = UIColor(rgb: 0xDFA683), backgroundColor: UIColor = UIColor(rgb: 0xC96C32), textColor: UIColor = UIColor(rgb: 0x1A1A1A), priceColor: UIColor = UIColor(rgb: 0x1A1A1A), justColor: UIColor = UIColor(rgb: 0x727272)) {
  ...
  private func setupWeaklyView(with boderWidth: CGFloat = 2, boderColor: UIColor = UIColor(rgb: 0xDFA683), backgroundColor: UIColor = UIColor(rgb: 0xC96C32), textColor: UIColor = UIColor(rgb: 0x1A1A1A), priceColor: UIColor = UIColor(rgb: 0x1A1A1A)) {
